...
*   **Automated Loan Default Prediction:** Utilizing high-performance XGBoost classifiers.
*   **MLflow Experiment Tracking:** Standardized logging and experiment registry management.
*   **PostgreSQL Data Persistence:** Thread-safe data transaction storage.
*   **Great Expectations Validation:** Strict data contract and schema assertions.
*   **Evidently AI Drift Monitoring:** Statistical distribution tracking using Kolmogorov-Smirnov audits.
*   **Automated Retraining Pipeline:** Event-driven model tuning loops triggered by feature drift.
*   **FastAPI Prediction Service:** Ultra-fast async inference endpoints.
*   **Docker Containerization:** Simplified multi-stage service deployment.
*   **GitHub Actions CI/CD:** Continuous validation and automatic container builds.
*   **Interactive Architecture Visualization:** Step-by-step browser walkthroughs.
...
![System Architecture Diagram](https://raw.githubusercontent.com/ItsYash40/TCS-Xcelerate-MLOps-A/main/architecture.svg)
...
*   👉 **[Interactive Presentation (architecture_viewer.html)](https://htmlpreview.github.io/?https://github.com/ItsYash40/TCS-Xcelerate-MLOps-A/blob/main/architecture_viewer.html)**: Open this link to render the presentation directly in your browser and step through the data loop, validation contracts, model registry, and drift checking step-by-step.
...
<table border="0" style="border: none; border-collapse: collapse; width: 100%; line-height: 1.8; font-size: 1.05em;">
<tr style="border: none;">
  <th style="border: 1px solid #eef2f5; text-align: left; width: 25%; font-weight: bold; color: #111; padding: 15px 22px;">Team Member</th>
...
<tr style="border: none;">
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; font-weight: bold; vertical-align: top;">Sourav Pati</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; color: #555; font-style: italic; vertical-align: top;">Configs & Fallback</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; font-weight: bold; vertical-align: top;">Arihanta Mishra</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; color: #555; font-style: italic; vertical-align: top;">Model Training</td>
</tr>
<tr style="border: none;">
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; font-weight: bold; vertical-align: top;">Samridhi Das</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; color: #555; font-style: italic; vertical-align: top;">Database Setup</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; font-weight: bold; vertical-align: top;">Aditya Mallick</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; color: #555; font-style: italic; vertical-align: top;">FastAPI Dev</td>
</tr>
<tr style="border: none;">
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; font-weight: bold; vertical-align: top;">Arghya Arpita</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; color: #555; font-style: italic; vertical-align: top;">Data Ingestion</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; font-weight: bold; vertical-align: top;">Om Prakash Nayak</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; color: #555; font-style: italic; vertical-align: top;">Docker Setup</td>
</tr>
<tr style="border: none;">
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; font-weight: bold; vertical-align: top;">Hrishika Ranjan</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px; color: #555; font-style: italic; vertical-align: top;">Data Validation</td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px;"></td>
  <td style="border: 1px solid #eef2f5; padding: 15px 22px;"></td>
</tr>
</table>
